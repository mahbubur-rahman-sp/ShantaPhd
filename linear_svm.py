...
x_vals = np.array([[x[0], x[499]] for x in wines.values])

# Specify the target labels and flatten the array
y_vals= np.ravel(wines.IS_MALWARE)
...
# x_vals_train, x_vals_test, y_vals_train, y_vals_test = train_test_split(x_vals, y_vals, test_size=0.3, random_state=42)
