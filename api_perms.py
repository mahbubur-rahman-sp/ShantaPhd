...
f = open('dangerousPerm1.csv', 'w')

for i in suspisus_permissions:
    f.write(i+",")

f.write("perm_network,perm_os,perm_personal,perm_system,perm_device,api_network,api_os,api_personal,api_system,api_device,IS_MALWARE\n")


process_folder('C:\\dataset\\labeled_benign\\drebin_log\\feature_vector_1',0)
process_folder('C:\\dataset\\labeled_Malware\\drebin_log\\malware-feature-vector',1)
process_folder('C:\\dataset\\labeled_benign\\drebin_log\\feature_vector_2',0)
process_folder("C:\\dataset\\labeled_Malware\\Androzo\\v2000",1)
